...
if results.solver.termination_condition == 'optimal':
    ...
    folder_name = current_time.strftime("OptimizationResults_SUMMER_50PShift_24HLimit_%Y-%m-%d_%H-%M-%S")
    ...
    file_name = current_time.strftime("OptimizationResults_SUMMER_50PShift_24HLimit_%Y-%m-%d_%H-%M-%S.xlsx")
